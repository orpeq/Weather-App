let appId = '228ff59bbb0a5cc9d837c0355c3f8f92';
let units = 'metric';
let searchMethod;
...
function setPositionForWeatherInfo() {
    ...
    let weatherCointainerWidth = weatherContainer.clientWidth;

    weatherContainer.style.left = `calc(50% - ${weatherCointainerWidth/ 2}px)`;
